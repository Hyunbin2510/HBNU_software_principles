...
public class NewIndoorNav : MonoBehaviour {
    ...
    [SerializeField] private GameObject sejongJointCampus2Prefab;    // "201"용
    [SerializeField] private GameObject sejongJointCampus2_1Prefab;  // "210"용
    ...
    private void Start() {
        var key = PlayerPrefs.GetString("SelectedDestination");
        if (key == "201") {
            trackedImagePrefab = sejongJointCampus2Prefab;
        }
        if (key == "210") {
            trackedImagePrefab = sejongJointCampus2_1Prefab;
        }
